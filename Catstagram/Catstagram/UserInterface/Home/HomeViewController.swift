...
class HomeViewController: UIViewController {
    ...
    let imagePickerViewcController = UIImagePickerController()
    ...
    override func viewDidLoad() {
        ...
        FeedDataManger().feedDataManager(input, self)
        
        imagePickerViewcController.delegate = self
    }

    // swift 사진 앨범 연동하기
    @IBAction func buttonGetAlbum(_ sender: Any) {
        self.imagePickerViewcController.sourceType = .photoLibrary
        self.present(imagePickerViewcController, animated: true, completion: nil)
    }
}
